...
public class RenderBlocks
{
    ...
    public void renderBottomFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        int var50 = ForgeHooksClient.getTextureSize(par1Block);
        int var51 = (int)Math.pow(var50, 2);
        
        double var12 = ((double)var10 + par1Block.minX * (double)var50) / var51;
        double var14 = ((double)var10 + par1Block.maxX * (double)var50 - 0.01D) / var51;
        double var16 = ((double)var11 + par1Block.minZ * (double)var50) / var51;
        double var18 = ((double)var11 + par1Block.maxZ * (double)var50 - 0.01D) / var51;
        
        if (par1Block.minX < 0.0D || par1Block.maxX > 1.0D)
        {
            var12 = (double)(((float)var10 + 0.0F) / var51);
            var14 = (double)(((float)var10 + var50) / var51);
        }

        if (par1Block.minZ < 0.0D || par1Block.maxZ > 1.0D)
        {
            var16 = (double)(((float)var11 + 0.0F) / var51);
            var18 = (double)(((float)var11 + var50) / var51);
        }
        ...
        {
            var12 = ((double)var10 + par1Block.minZ * (double)var50) / var51;
            var16 = ((double)(var11 + var50) - par1Block.maxX * (double)var50) / var51;
            var14 = ((double)var10 + par1Block.maxZ * (double)var50) / var51;
            var18 = ((double)(var11 + var50) - par1Block.minX * (double)var50) / var51;
            var24 = var16;
            var26 = var18;
            var20 = var12;
            var22 = var14;
        ...
        {
            var12 = ((double)(var10 + var50) - par1Block.maxZ * (double)var50) / var51;
            var16 = ((double)var11 + par1Block.minX * (double)var50) / var51;
            var14 = ((double)(var10 + var50) - par1Block.minZ * (double)var50) / var51;
            var18 = ((double)var11 + par1Block.maxX * (double)var50) / var51;
            var20 = var14;
            var22 = var12;
            var12 = var14;
            var14 = var22;
        ...
        {
            var12 = ((double)(var10 + var50) - par1Block.minX * (double)var50) / var51;
            var14 = ((double)(var10 + var50) - par1Block.maxX * (double)var50 - 0.01D) / var51;
            var16 = ((double)(var11 + var50) - par1Block.minZ * (double)var50) / var51;
            var18 = ((double)(var11 + var50) - par1Block.maxZ * (double)var50 - 0.01D) / var51;
            var20 = var14;
            var22 = var12;
            var24 = var16;
            var26 = var18;
    ...
    public void renderEastFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        double var12 = ((double)var10 + par1Block.minX * (double)var50) / var51;
        double var14 = ((double)var10 + par1Block.maxX * (double)var50 - 0.01D) / var51;
        double var16 = ((double)(var11 + var50) - par1Block.maxY * (double)var50) / var51;
        double var18 = ((double)(var11 + var50) - par1Block.minY * (double)var50 - 0.01D) / var51;
        double var20;
        ...
        {
            var12 = ((double)var10 + par1Block.minY * (double)var50) / var51;
            var16 = ((double)(var11 + var50) - par1Block.minX * (double)var50) / var51;
            var14 = ((double)var10 + par1Block.maxY * (double)var50) / var51;
            var18 = ((double)(var11 + var50) - par1Block.maxX * (double)var50) / var51;
            var24 = var16;
            var26 = var18;
            var20 = var12;
            var22 = var14;
        ...
        {
            var12 = ((double)(var10 + var50) - par1Block.maxY * (double)var50) / var51;
            var16 = ((double)var11 + par1Block.maxX * (double)var50) / var51;
            var14 = ((double)(var10 + var50) - par1Block.minY * (double)var50) / var51;
            var18 = ((double)var11 + par1Block.minX * (double)var50) / var51;
            var20 = var14;
            var22 = var12;
            var12 = var14;
            var14 = var22;
        ...
        else if (this.uvRotateEast == 3)
        {
            var12 = ((double)(var10 + var50) - par1Block.minX * (double)var50) / var51;
            var14 = ((double)(var10 + var50) - par1Block.maxX * (double)var50 - 0.01D) / var51;
            var16 = ((double)var11 + par1Block.maxY * (double)var50) / var51;
            var18 = ((double)var11 + par1Block.minY * (double)var50 - 0.01D) / var51;
            var20 = var14;
            var22 = var12;
            var24 = var16;
            var26 = var18;
    ...
    public void renderNorthFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        double var12 = ((double)var10 + par1Block.minZ * (double)var50) / var51;
        double var14 = ((double)var10 + par1Block.maxZ * (double)var50 - 0.01D) / var51;
        double var16 = ((double)(var11 + var50) - par1Block.maxY * (double)var50) / var51;
        double var18 = ((double)(var11 + var50) - par1Block.minY * (double)var50 - 0.01D) / var51;
        double var20;
        ...
        {
            var12 = ((double)var10 + par1Block.minY * (double)var50) / var51;
            var16 = ((double)(var11 + var50) - par1Block.maxZ * (double)var50) / var51;
            var14 = ((double)var10 + par1Block.maxY * (double)var50) / var51;
            var18 = ((double)(var11 + var50) - par1Block.minZ * (double)var50) / var51;
            var24 = var16;
            var26 = var18;
            var20 = var12;
            var22 = var14;
        ...
        {
            var12 = ((double)(var10 + var50) - par1Block.maxY * (double)var50) / var51;
            var16 = ((double)var11 + par1Block.minZ * (double)var50) / var51;
            var14 = ((double)(var10 + var50) - par1Block.minY * (double)var50) / var51;
            var18 = ((double)var11 + par1Block.maxZ * (double)var50) / var51;
            var20 = var14;
            var22 = var12;
            var12 = var14;
            var14 = var22;
        ...
        {
            var12 = ((double)(var10 + var50) - par1Block.minZ * (double)var50) / var51;
            var14 = ((double)(var10 + var50) - par1Block.maxZ * (double)var50 - 0.01D) / var51;
            var16 = ((double)var11 + par1Block.maxY * (double)var50) / var51;
            var18 = ((double)var11 + par1Block.minY * (double)var50 - 0.01D) / var51;
            var20 = var14;
            var22 = var12;
    ...
    public void renderSouthFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (this.uvRotateSouth == 2)
        {
            ...
            var16 = ((double)(var11 + var50) - par1Block.minZ * (double)var50) / var51;
            var14 = ((double)var10 + par1Block.maxY * (double)var50) / var51;
            var18 = ((double)(var11 + var50) - par1Block.maxZ * (double)var50) / var51;
            var24 = var16;
            var26 = var18;
            var20 = var12;
            var22 = var14;
        ...
        {
            var12 = ((double)(var10 + var50) - par1Block.maxY * (double)var50) / var51;
            var16 = ((double)var11 + par1Block.maxZ * (double)var50) / var51;
            var14 = ((double)(var10 + var50) - par1Block.minY * (double)var50) / var51;
            var18 = ((double)var11 + par1Block.minZ * (double)var50) / var51;
            var20 = var14;
            var22 = var12;
            var12 = var14;
            var14 = var22;
	...
	public void renderHiResBlock(Block block, int x, int y, int z) 
	{
